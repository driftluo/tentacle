...
impl From<Vec<u8>> for Secp256k1 {
...
impl ProposeBuilder {
    pub const FIELD_COUNT: usize = 5;
    pub fn rand<T>(mut self, v: T) -> Self
    where
    ...
    pub fn pubkey<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Bytes>,
    {
        self.pubkey = v.into();
    ...
    pub fn exchanges<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<String>,
    {
        self.exchanges = v.into();
        self
    }
    pub fn ciphers<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<String>,
    {
        self.ciphers = v.into();
...
impl ExchangeBuilder {
    pub const FIELD_COUNT: usize = 2;
    pub fn epubkey<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Bytes>,
    {
        self.epubkey = v.into();
    ...
    pub fn signature<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Bytes>,
    {
