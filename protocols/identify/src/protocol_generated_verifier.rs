    ...
    pub mod identify {
        ...
        impl<'a> Verify for reader::Address<'a> {
            fn verify(&self) -> Result {
                ...
                if Self::VT_BYTES as usize + flatbuffers::SIZE_VOFFSET <= vtab_num_bytes {
        ...
        impl<'a> Verify for reader::ListenAddrs<'a> {
            fn verify(&self) -> Result {
                ...
                if Self::VT_ADDRS as usize + flatbuffers::SIZE_VOFFSET <= vtab_num_bytes {
                    ...
                    if voffset > 0 {
                        ...
                        let addrs_verifier =
                            VectorVerifier::follow(buf, try_follow_uoffset(buf, tab.loc + voffset)?);
                        addrs_verifier.verify_reference_elements::<reader::Address>()?;
                    }
                }
        ...
        impl<'a> Verify for reader::ObservedAddr<'a> {
            fn verify(&self) -> Result {
                ...
                if Self::VT_ADDR as usize + flatbuffers::SIZE_VOFFSET <= vtab_num_bytes {
