...
pub mod p2p {
    ...
    pub mod ping {
        ...
        const ENUM_VALUES_PING_PAYLOAD: [PingPayload; 3] =
            [PingPayload::NONE, PingPayload::Ping, PingPayload::Pong];

        #[allow(non_camel_case_types)]
        const ENUM_NAMES_PING_PAYLOAD: [&'static str; 3] = ["NONE", "Ping", "Pong"];
        ...
        impl<'a> PingMessage<'a> {
            ...
            pub fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
                PingMessage { _tab: table }
            }
            #[allow(unused_mut)]
            pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
                _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
                args: &'args PingMessageArgs,
            ) -> flatbuffers::WIPOffset<PingMessage<'bldr>> {
            ...
            pub fn payload_type(&self) -> PingPayload {
                self._tab
                    .get::<PingPayload>(PingMessage::VT_PAYLOAD_TYPE, Some(PingPayload::NONE))
                    .unwrap()
            }
            #[inline]
        ...
        impl<'a: 'b, 'b> PingMessageBuilder<'a, 'b> {
            ...
            pub fn add_payload_type(&mut self, payload_type: PingPayload) {
                self.fbb_.push_slot::<PingPayload>(
                    PingMessage::VT_PAYLOAD_TYPE,
                    payload_type,
                    PingPayload::NONE,
                );
            }
